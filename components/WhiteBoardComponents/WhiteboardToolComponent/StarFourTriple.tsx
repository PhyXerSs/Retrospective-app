...
function StarFourTriple(rect: RectStateType, imageRef: React.MutableRefObject<any>, starFourTripleImage: HTMLImageElement | undefined, stroke: string, handleTransformChange: any, isYourSelect: boolean) {
    return <>
      <Image
        key={rect.rectId}
        id={rect.rectId}
