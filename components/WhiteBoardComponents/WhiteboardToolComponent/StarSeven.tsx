...
function StarSeven(regularRef: React.MutableRefObject<any>, stroke: string, rect: RectStateType, handleTransformChange: any, isYourSelect: boolean) {
    return <>
      <Star
        ref={regularRef}
        width={100}
