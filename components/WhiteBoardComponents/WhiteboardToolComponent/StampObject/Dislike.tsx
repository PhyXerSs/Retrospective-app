...
function Dislike(rect: RectStateType, dislikeRef: React.MutableRefObject<any>, dislike: HTMLImageElement | undefined, stroke: string, handleTransformChange: any, isYourSelect: boolean) {
    return <>
      <Image
        key={rect.rectId}
        id={rect.rectId}
