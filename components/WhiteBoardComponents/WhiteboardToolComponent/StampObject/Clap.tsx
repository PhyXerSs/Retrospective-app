...
function Clap(rect: RectStateType, clapRef: React.MutableRefObject<any>, clapclap: HTMLImageElement | undefined, stroke: string, handleTransformChange: any, isYourSelect: boolean) {
    return <>
      <Image
        key={rect.rectId}
        id={rect.rectId}
